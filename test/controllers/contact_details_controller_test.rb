...
class ContactDetailsControllerTest < ActionController::TestCase
  ...
  test "should create contact_detail" do
    assert_difference('ContactDetail.count') do
      post :create, contact_detail: { address: @contact_detail.address, name: @contact_detail.name, phone: @contact_detail.phone }
    end
  ...
  test "should update contact_detail" do
    patch :update, id: @contact_detail, contact_detail: { address: @contact_detail.address, name: @contact_detail.name, phone: @contact_detail.phone }
    assert_redirected_to contact_detail_path(assigns(:contact_detail))
  end
